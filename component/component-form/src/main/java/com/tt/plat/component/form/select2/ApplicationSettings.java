 ...
 * {@link org.apache.wicket.protocol.http.WebApplication#init()} method.
 * 
 * @author igor
 */
public class ApplicationSettings {
    ...
    private ResourceReference javaScriptReference =  new UrlResourceReference(Url.parse("/res/melon/plugins/select2/select2.min.js"));
    private ResourceReference mouseWheelReference = new UrlResourceReference(Url.parse("/res/jquery.mousewheel.js"));

    private ResourceReference cssReference = new UrlResourceReference(Url.parse("/res/melon/assets/css/plugins/select2.css"));

    private ResourceReference jqueryUIReference = new UrlResourceReference(Url.parse("/res/jquery-1.10.2.min.js"));
