...
public class FileUploadBehavior extends Behavior {
    ...
    public FileUploadBehavior(IFileManager fileManager) {
    ...
    public void renderHead(Component component, IHeaderResponse response) {
        ...
        variables.put("url", component.urlFor(new FileUploadResourceReference(fileManager), null)+"?managerUrl="+component.urlFor(new FileManageResourceReference(fileManager),null));
