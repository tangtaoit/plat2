...
$.fn.ProvinceCity = function(){
	var _self = this;
	//定义3个默认值
	_self.data("province",[" 省", " 省"]);
	_self.data("city1",[" 市", " 市"]);
	_self.data("city2",[" 区", " 区"]);
	//插入3个空的下拉框
	//_self.append("<select wicket:id='province'></select><span class='must_span'>*</span>");
	//_self.append("<select style='width:125px' wicket:id='city'></select>");
	//_self.append("<select style='width:125px; margin-left:10px;' wicket:id='area'></select><span class='must_span'>*</span>");
	//分别获取3个下拉框
