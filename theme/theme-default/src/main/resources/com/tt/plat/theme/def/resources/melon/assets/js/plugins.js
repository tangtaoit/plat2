var Plugins = function () {
    ...
    var l = function () {
        $.extend(true, $.fn.tooltip.defaults, {container: "body"});
        $(".bs-tooltip").tooltip({container: "body"});
        $(".bs-focus-tooltip").tooltip({trigger: "focus", container: "body"})
    };
    var h = function () {
        $(".bs-popover").popover()
    };
    var d = function () {
        if ($.noty) {
            $.extend(true, $.noty.defaults, {type: "alert", timeout: false, maxVisible: 5, animation: {open: {height: "toggle"}, close: {height: "toggle"}, easing: "swing", speed: 200}})
        }
    };
    var c = function () {
        if ($.easyPieChart) {
            $.extend(true, $.easyPieChart.defaultOptions, {lineCap: "butt", animate: 500, barColor: App.getLayoutColorCode("blue")});
            $(".circular-chart").easyPieChart({size: 110, lineWidth: 10})
        }
    };
//    var m = function () {
//        if ($.fn.dataTable) {
//            $.extend(true, $.fn.dataTable.defaults, {oLanguage: {sSearch: ""}, sDom: "<'row'<'dataTables_header clearfix'<'col-md-6'l><'col-md-6'f>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", iDisplayLength: 5, fnDrawCallback: function () {
//                if ($.fn.uniform) {
...
//                    $.extend(true, y, {iDisplayLength: x})
//                }
//                var r = w.data("horizontalWidth");
//                if (typeof r != "undefined") {
//                    $.extend(true, y, {sScrollX: "100%", sScrollXInner: r, bScrollCollapse: true})
//                }
//                if (w.hasClass("table-checkable")) {
//                    $.extend(true, y, {aoColumnDefs: [
//                        {bSortable: false, aTargets: [0]}
//                    ]})
//                }
//                if (w.hasClass("table-tabletools")) {
//                    $.extend(true, y, {sDom: "<'row'<'dataTables_header clearfix'<'col-md-4'l><'col-md-8'Tf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", oTableTools: {aButtons: ["copy", "print", "csv", "xls", "pdf"], sSwfPath: "plugins/datatables/tabletools/swf/copy_csv_xls_pdf.swf"}})
//                }
//                if (w.hasClass("table-colvis")) {
//                    $.extend(true, y, {sDom: "<'row'<'dataTables_header clearfix'<'col-md-6'l><'col-md-6'Cf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", oColVis: {buttonText: "Columns <i class='icon-angle-down'></i>", iOverlayFade: 0}})
//                }
//                if (w.hasClass("table-tabletools") && w.hasClass("table-colvis")) {
//                    $.extend(true, y, {sDom: "<'row'<'dataTables_header clearfix'<'col-md-6'l><'col-md-6'TCf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", })
//                }
//                if (w.hasClass("table-checkable") && w.hasClass("table-colvis")) {
//                    $.extend(true, y, {oColVis: {aiExclude: [0]}})
//                }
//                if (w.hasClass("table-responsive")) {
//                    var q;
//                    var p = {tablet: 1024, phone: 480};
//                    var t = $.fn.dataTable.defaults.fnDrawCallback;
//                    $.extend(true, y, {bAutoWidth: false, fnPreDrawCallback: function () {
//                        if (!q) {
...
//                            $(this).children("select").addClass("full-width-fix").select2({placeholderOption: "first"})
//                        } else {
...
//        }
//    };
    var j = {colors: [App.getLayoutColorCode("blue"), App.getLayoutColorCode("red"), App.getLayoutColorCode("green"), App.getLayoutColorCode("purple"), App.getLayoutColorCode("grey"), App.getLayoutColorCode("yellow")], legend: {show: true, labelBoxBorderColor: "", backgroundOpacity: 0.95}, series: {points: {show: false, radius: 3, lineWidth: 2, fill: true, fillColor: "#ffffff", symbol: "circle"}, lines: {show: true, lineWidth: 2, fill: false, fillColor: {colors: [
        {opacity: 0.4},
        {opacity: 0.1}
    ]}, }, bars: {lineWidth: 1, barWidth: 1, fill: true, fillColor: {colors: [
        {opacity: 0.7},
        {opacity: 1}
    ]}, align: "left", horizontal: false}, pie: {show: false, radius: 1, label: {show: false, radius: 2 / 3, formatter: function (o, p) {
    ...
    }, threshold: 0.1}}, shadowSize: 0}, grid: {show: true, borderColor: "#efefef", tickColor: "rgba(0,0,0,0.06)", labelMargin: 10, axisMargin: 8, borderWidth: 0, minBorderMargin: 10, mouseActiveRadius: 5}, tooltipOpts: {defaultTheme: false}, selection: {color: App.getLayoutColorCode("blue")}};
    var b = {colors: ["#ffffff"], legend: {show: false, backgroundOpacity: 0}, series: {points: {}}, grid: {tickColor: "rgba(255, 255, 255, 0.1)", color: "#ffffff", }, shadowSize: 1};
    var f = function () {
        if ($.fn.knob) {
            $(".knob").knob();
            $(".knob").each(function () {
                if (typeof $(this).attr("data-fgColor") == "undefined") {
                    $(this).trigger("configure", {fgColor: App.getLayoutColorCode("blue"), inputColor: App.getLayoutColorCode("blue")})
                }
            })
        }
    };
    var n = {type: "bar", height: "19px", zeroAxis: false, barWidth: "4px", barSpacing: "1px", barColor: "#fff"};
    var e = function () {
        if ($.fn.colorpicker) {
